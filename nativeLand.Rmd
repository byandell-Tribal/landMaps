...
```{r warning = FALSE}
landMaps::ggplot_sf(color = oceti_sakowin$color) + 
  landMaps::ggplot_layer_sf(oceti_sakowin) +
  landMaps::ggplot_layer_name(oceti_sakowin) +
...
```{r warning=FALSE}
landMaps::ggplot_sf(color = menominee$color) + 
  ggspatial::annotation_map_tile(type = "osm", zoomin = -1) +
  landMaps::ggplot_layer_sf(menominee) +
...
```{r warning = FALSE}
landMaps::ggplot_sf(color = c(nl_bbox_mnwimi$color, census_geometry$color)) + 
  ggspatial::annotation_map_tile(type = "osm", zoomin = -1) +
  landMaps::ggplot_layer_sf(nl_bbox_mnwimi) +
...
```{r warning = FALSE}
landMaps::ggplot_sf(color = c(nl_mnwimi$color, census_geometry$color)) +
  ggspatial::annotation_map_tile(type = "osm", zoomin = -1, progress = "none") +
  landMaps::ggplot_layer_sf(nl_mnwimi) +
  ggplot2::ggtitle("Native Land in MN/WI/MI") +
  landMaps:::ggplot_layer_sf(
    dplyr::filter(census_geometry, category == "states",
                  Name %in% c("Wisconsin", "Minnesota", "Michigan"))) +
