---
title: "Land Mapps<br>with package `landmapr`"
...
## Census App `censusApp()` {.scrollable .smaller}

```{.r filename="https://github.com/byandell-envsys/landmapr/R/census.R" code-line-numbers="|2|4-14|15-18"}
censusApp <- function() {
...
```{.r filename="https://github.com/byandell-envsys/landmapr/R/census.R" code-line-numbers="|1-10|11-14|15-18|19-23|"}
...
```{.r filename="https://github.com/byandell-envsys/landmapr/R/landGgplot.R" code-line-numbers="|1-8|9-19|20-35|"}
...
## Full `landmapr` app {.scrollable .smaller}

```{.r filename="https://github.com/byandell-envsys/landmapr/R/landmapr.R" code-line-numbers="|2-4|8-15|17-18"}
...
## Server for full `landmapr` {.scrollable .smaller}

```{.r filename="https://github.com/byandell-envsys/landmapr/R/landmapr.R" code-line-numbers="|3-4|6-8|14-16|"}
...
```{.r filename="https://github.com/byandell-envsys/landmapr/R/landmapr.R" code-line-numbers="|2|4-9|14|18"}
...
```{.r filename="https://github.com/byandell-envsys/landmapr/R/landmapr.R" code-line-numbers="|3-4|6-10|12-16|18-21|"}
landmaprServer <- function(id, 
    nativeLandSlug, nativeLandUS, census_geometry) {
  shiny::moduleServer(id, function(input, output, session) {
    ns <- session$ns
