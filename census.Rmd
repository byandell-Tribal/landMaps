...
- [US Census Maps Data Setup]([censusSetup.Rmd](https://github.com/byandell-Tribal/landMaps/blob/main/censusSetup.Rmd)
)
...
```{r}
sd <- census_geometry |>
  dplyr::filter(geography == "states", NAME == "South Dakota")
```
